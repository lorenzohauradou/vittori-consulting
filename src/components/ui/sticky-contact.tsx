...
export default function StickyContact({ whatsappOnly = false }: StickyContactProps) {
    return (
        <div className="fixed bottom-8 right-8 flex flex-col space-y-4 z-[9999]">
            <a
                href="https://wa.me/393513708950?text=Ciao,%20vorrei%20avere%20più%20informazioni%20😊"
                target="_blank"
            ...
            {!whatsappOnly && (
                <>
                    <a
                        ...
                        className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white hover:bg-blue-700 transition-colors shadow-lg"
                    >
                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
