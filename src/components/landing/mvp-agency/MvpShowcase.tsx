...
export default function MvpShowcase() {
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            ...
            if (directionRef.current === 1 && container.scrollLeft >= maxScroll - 2) {
                directionRef.current = -1
            } else if (directionRef.current === -1 && container.scrollLeft <= 2) {
                directionRef.current = 1
            }

            container.scrollLeft += directionRef.current * 1
        }, 30)
