            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-16">
                    ...
                    <div className="md:grid md:grid-cols-3 gap-8">
                        <div className="md:hidden overflow-x-auto pb-4 scrollbar-hide -mx-4">
                            <div className="flex gap-6 px-4">
                                {testimonials.map((testimonial) => (
                                    <div
                                        key={testimonial.id}
                                        className="flex-shrink-0 w-80 group relative bg-white rounded-2xl shadow-lg overflow-hidden border-2 border-gray-100 hover:border-[#2e54a1]/30 transition-all duration-300 hover:shadow-2xl"
                                    >
                ...
                <div className="bg-gradient-to-br from-[#2e54a1] to-[#1e3a70] rounded-3xl p-6 sm:p-8 shadow-2xl">
                    ...
                    <div className="grid sm:grid-cols-3 gap-4">
                        {finalNumbers.map((item, index) => (
                            <div
                                key={index}
                                className="bg-white/10 backdrop-blur-sm rounded-xl p-5 border-2 border-white/20 text-center hover:bg-white/20 transition-all duration-300"
                            >
