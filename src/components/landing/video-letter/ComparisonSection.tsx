    ...
    return (
        <section className="relative py-20 bg-linear-to-b from-white to-blue-50 overflow-hidden">
            <div className="absolute inset-0">
                ...
                <div className="absolute md:hidden -bottom-20 -right-40 w-3/5 h-250 bg-linear-to-br from-[#2e54a1] via-[#3d63b8] to-[#1e3a70] transform -skew-x-12"></div>
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <div className="inline-block bg-linear-to-r from-[#2e54a1] to-[#1e3a70] rounded-2xl px-8 py-4 mb-8 shadow-xl transform hover:scale-105 transition-transform">
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="bg-linear-to-r from-gray-100 to-gray-50">
                                    ...
                                    <th className="px-6 py-6 text-center text-xl font-bold text-white bg-linear-to-br from-[#2e54a1] to-[#1e3a70] border-b-2 border-[#2e54a1] w-3/8">
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-5 border-b border-gray-200 bg-[#2e54a1]/5">
                                            <div className="flex items-start gap-3">
                                                <svg className="w-6 h-6 text-[#2e54a1] shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                                </svg>
                                        ...
                                        <td className="px-6 py-5 border-b border-gray-200">
                                            <div className="flex items-start gap-3">
                                                <svg className="w-6 h-6 text-gray-400 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="md:hidden space-y-6">
                    {comparisons.map((item, index) => (
                        <div key={index} className="bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-[#2e54a1]/20">
                            <div className="bg-linear-to-r from-gray-100 to-gray-50 px-6 py-4 border-b-2 border-gray-200">
