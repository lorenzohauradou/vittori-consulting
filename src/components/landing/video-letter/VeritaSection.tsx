...
export default function VeritaSection() {
    ...
    return (
        <section className="relative py-24 lg:py-32 bg-linear-to-br from-[#1e3a70] via-[#2e54a1] to-[#3d63b8] overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <div className="text-center">
                        <div className="inline-block bg-linear-to-r from-blue-100 to-cyan-100 rounded-xl px-6 py-3 mb-8 transform -rotate-1">
                            <h3 className="text-2xl sm:text-3xl font-black bg-linear-to-r from-[#2e54a1] to-[#1e3a70] bg-clip-text text-transparent">
                    ...
                    >
                        <div className="bg-white/15 backdrop-blur-md rounded-3xl p-8 border border-white/30 shadow-xl">
                            <div className="flex flex-col items-center text-center mb-8">
                                <div className="w-16 h-16 bg-linear-to-br from-red-500/30 to-orange-500/30 backdrop-blur-sm rounded-2xl flex items-center justify-center border-2 border-white/30 mb-6">
