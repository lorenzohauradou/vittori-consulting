                ...
                <div className="text-center">
                        ...
                        <div className="max-w-2xl mx-auto">
                            ...
                            <div className="mt-6 flex flex-wrap items-center justify-center gap-6 text-sm text-gray-600">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-medium">Soddisfatti o rimborsati</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <svg className="w-5 h-5 text-[#2e54a1]" fill="currentColor" viewBox="0 0 20 20">
                                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                    </svg>
                                    <span className="font-medium">Posti limitati</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-3 gap-6 text-white">
                        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                            ...
                            <div className="text-blue-100">Imprenditori soddisfatti</div>
                        </div>
                        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                            <div className="text-4xl font-bold mb-2">+50%</div>
                            <div className="text-blue-100">Crescita media clienti</div>
                        </div>
                        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                            <div className="text-4xl font-bold mb-2">6 mesi</div>
                            <div className="text-blue-100">Per risultati concreti</div>
                        </div>
                    </div>
                </div>
            </div>
