            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid lg:grid-cols-2 gap-16">
                    <div>
                        ...
                        <div className="mb-8">
                            <h4 className="text-xl font-bold text-white mb-4">Contatti</h4>
                            <div className="space-y-3 mb-6">
                                <div className="flex items-start gap-3">
                                    <svg className="w-5 h-5 text-blue-400 shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                                    </svg>
                                    <div>
                                        <a href="https://maps.google.com/?q=Via+Crescenzo+del+Monte+29,+Roma+00153" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-blue-400 transition-colors">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <a href="tel:+393513708950" className="text-gray-300 hover:text-blue-400 transition-colors">
                                        +39 351 370 8950
                                    </a>
                                </div>
                                <div className="flex items-start gap-3">
                                    ...
                                    <a href="mailto:info@vittoriconsulting.it" className="text-gray-300 hover:text-blue-400 transition-colors">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    <button
                                        ...
                                        className={`w-full bg-linear-to-r from-blue-600 to-blue-700 text-white font-bold py-4 px-8 rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg ${isSubmitting ? 'opacity-50 cursor-not-allowed' : 'hover:scale-105'}`}
                                    >
