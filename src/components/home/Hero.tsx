...
export default function Hero() {
    ...
    return (
        <CustomBackground variant="hero" className="min-h-screen flex flex-col pt-16">
            <div className="bg-white/95 backdrop-blur-sm border-b max-w-4xl mx-auto rounded-3xl border-white/20 shadow-sm mt-16">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm">
                        <div className="flex items-center gap-6">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-gray-700 font-medium">+39 06 1234 5678</span>
                            </div>
                        </div>
