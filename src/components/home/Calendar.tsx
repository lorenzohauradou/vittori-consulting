                ...
                <div className="text-center">
                    ...
                    <div className="max-w-4xl mx-auto mb-12 sm:mb-16">
                        <div className="bg-[#2e54a1] rounded-2xl sm:rounded-3xl p-4 sm:p-8 lg:p-12 shadow-xl border border-white/50">
                            <p className="text-base sm:text-lg lg:text-xl text-white leading-relaxed mb-6 sm:mb-8">
                            ...
                            <div className="mb-8 sm:mb-10">
                                <div className="bg-white/15 backdrop-blur-md rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 border border-white/30 shadow-xl">
                                    ...
                                    <div className="bg-white/10 backdrop-blur-md rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-white/20 shadow-2xl mb-4">
                                        <div className="flex items-center justify-between mb-4 sm:mb-6">
                                            <button
                                                ...
                                                className="p-1.5 sm:p-2 rounded-full bg-white/20 backdrop-blur-sm hover:bg-white/30 hover:scale-110 active:scale-90 transition-all duration-300 border border-white/30"
                                            >
                                                        ...
                                                        className={`aspect-square rounded-lg sm:rounded-xl flex items-center justify-center text-sm sm:text-lg font-semibold transition-all duration-300 border
                                                            ${selected
                                                                ...
                                                                : disabled
                                                                    ...
                                                                    : 'bg-white/10 text-white border-white/20 hover:bg-white/20 hover:border-white/40 hover:scale-105 active:scale-95'
                                                            }`}
                                                    >
                                                        {day}
                                                    </button>
                                    ...
                                    {selectedDate && selectedTime && (
                                        <div className="mt-4 p-4 sm:p-6 bg-white/20 backdrop-blur-md rounded-xl sm:rounded-2xl border-2 border-white/40 shadow-xl">
                    ...
                    <div className="text-center px-4">
                        <button
                            ...
                            className={`relative inline-flex items-center justify-center px-8 sm:px-12 py-4 sm:py-5 text-base sm:text-xl font-bold rounded-full shadow-2xl transition-all duration-300 group overflow-hidden w-full sm:w-auto ${selectedDate && selectedTime
                                ? 'text-white bg-gradient-to-r from-[#2e54a1] to-blue-600 hover:shadow-3xl hover:scale-105 active:scale-95 cursor-pointer'
