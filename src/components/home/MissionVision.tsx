...
export default function MissionVision() {
    return (
        <section className="relative py-32 lg:py-40 overflow-hidden bg-gradient-to-br from-[#2e54a1] via-[#3d63b8] to-[#4f75c7]">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-8">
                    <div className="relative bg-white rounded-3xl p-10 sm:p-12 lg:p-16 shadow-2xl">
                        ...
                        <div className="flex items-center gap-5 mb-10 pb-8 border-b-2 border-gray-100">
                            <div className="flex-shrink-0">
                                <div className="w-16 h-16 bg-gradient-to-br from-[#2e54a1] to-[#4f75c7] rounded-2xl flex items-center justify-center">
                                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                </div>
                            </div>
                            <h3 className="text-4xl font-bold text-[#2e54a1]">Mission</h3>
                        </div>
                        ...
                        <div className="space-y-5 text-gray-700 text-lg leading-relaxed">
                            ...
                            <div className="pt-6 mt-6 border-t border-gray-200">
                                <p className="text-xl font-bold text-[#2e54a1]">
                    ...
                    <div className="relative bg-white rounded-3xl p-10 sm:p-12 lg:p-16 shadow-2xl">
                        ...
                        <div className="flex items-center gap-5 mb-10 pb-8 border-b-2 border-gray-100">
                            <div className="flex-shrink-0">
                                <div className="w-16 h-16 bg-gradient-to-br from-[#4f75c7] to-[#2e54a1] rounded-2xl flex items-center justify-center">
                                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <h3 className="text-4xl font-bold text-[#2e54a1]">Vision</h3>
                        </div>
