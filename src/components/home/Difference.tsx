            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="relative z-10 flex justify-center lg:justify-end">
                        <IPhoneCanvas iframeSrc="https://iframe.mediadelivery.net/embed/510109/0eb84004-f16b-48cb-a1b4-33b415d99bb5?autoplay=true&loop=true&muted=true&preload=true&responsive=true&playsinline=true&disableIosPlayer=true" />
                    </div>
                </div>
            </div>
        </section>
